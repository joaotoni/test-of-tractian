...
export default function WhoWeServeMegaMenu({ lang, onNavigate, variant = 'desktop' }: Props) {
    ...
    return (
      <div className="rounded-md bg-slate-50 p-3">
        <div className="space-y-6">
          <div>
            <h3 className="text-sm font-medium text-slate-500">{t('sections.byRole')}</h3>
          ...
          <div>
            <h3 className="text-sm font-medium text-slate-500">{t('sections.bySector')}</h3>
